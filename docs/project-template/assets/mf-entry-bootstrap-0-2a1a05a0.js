...
(async () => {
  const __mfHostInit = await __mfImport("./hostInit-B5DzViNf.js");
  ...
  const __mfRemotePreloads = [__mfPreloadRemote("cyweb/NetworkApi"),__mfPreloadRemote("cyweb/WorkspaceApi")];
