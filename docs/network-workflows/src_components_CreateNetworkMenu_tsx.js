"use strict";
(self["webpackChunk_cytoscape_web_network_workflows"] = self["webpackChunk_cytoscape_web_network_workflows"] || []).push([["src_components_CreateNetworkMenu_tsx"],{
...
/***/ "./src/components/CreateNetworkMenu.tsx"
/*!**********************************************!*\
  !*** ./src/components/CreateNetworkMenu.tsx ***!
  \**********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const CreateNetworkMenu = () => {
    ...
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_1__["default"], { onClick: handleClick, sx: {
        ...
        }, children: "Create an example network" }));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CreateNetworkMenu);
