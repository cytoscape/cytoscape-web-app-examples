...
export async function handleTool(
  ...
  if (layoutToolNames.has(toolName)) {
    return handleLayoutTool(page, toolName, params)
  }
  if (viewportToolNames.has(toolName)) {
    return handleViewportTool(page, toolName, params)
  }
